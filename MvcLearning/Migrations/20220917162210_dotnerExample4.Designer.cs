...
namespace MvcLearning.Migrations
{
    ...
    [Migration("20220917162210_dotnerExample4")]
    partial class dotnerExample4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvcLearning.Models.Classes.SalesMovement", b =>
                {
                    ...
                    b.Property<int>("CurrrentcurrentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MvcLearning.Models.Classes.SalesMovement", b =>
                {
                    b.HasOne("MvcLearning.Models.Classes.Currrent", "Currrent")
                        .WithMany("SalesMovements")
                        .HasForeignKey("CurrrentcurrentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MvcLearning.Models.Classes.Personal", "Personal")
                        .WithMany("SalesMovements")
                        .HasForeignKey("personalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MvcLearning.Models.Classes.Product", "Product")
                        .WithMany("SalesMovements")
                        .HasForeignKey("productId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Currrent");
